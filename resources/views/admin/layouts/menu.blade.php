            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Tüm Bölümler</h6>
                        <a class="collapse-item" href="{{route("admin.user.index")}}">Kullanıcılar</a>
                        <a class="collapse-item" href="{{route("admin.company.index")}}">Şirketler</a>
                    </div>
                </div>
            </li>
